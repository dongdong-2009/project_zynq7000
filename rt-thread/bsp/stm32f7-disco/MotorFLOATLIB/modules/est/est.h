...
extern int32_t EST_computeLr_H(EST_Handle handle,const float_t current);
#else
extern float_t EST_computeLr_H(EST_Handle handle,const float_t current);
#endif
...
//! #define USER_IQ_FULL_SCALE_FREQ_Hz      (500.0)
//!
//! float_t scale_factor = IQ(60.0 * USER_IQ_FULL_SCALE_FREQ_Hz / (USER_MOTOR_NUM_POLE_PAIRS * 1000.0));
//!
//! float_t Speed_pu = EST_getFm_pu(handle);
//! float_t Speed_pu_to_krpm_sf = EST_get_pu_to_krpm_sf(handle);
//! float_t Speed_krpm = _IQmpy(Speed_krpm,Speed_krpm_to_pu_sf);
//! \endcode
//! \param[in] handle  The estimator (EST) handle
...
//!            scale factor:
//! \code
//! float_t Full_Scale_Freq_Elec_Hz = _IQ(USER_IQ_FULL_SCALE_FREQ_Hz);
//!
//! float_t Freq_Elec_Hz = _IQmpy(EST_getFe_pu(handle),Full_Scale_Freq_Elec_Hz);
//! \endcode
//! \param[in] handle  The estimator (EST) handle
//! \return    The electrical frequency, pu
extern float_t EST_getFe_pu(EST_Handle handle);
...
extern float_t EST_getFreqB0_lp_pu(EST_Handle handle);
...
extern float_t EST_getFreqBeta_lp_pu(EST_Handle handle);
...
//! float_t Full_Scale_Freq_Elec_Hz = _IQ(USER_IQ_FULL_SCALE_FREQ_Hz);
//!
//! float_t Freq_Slip_Hz = _IQmpy(EST_getFslip_pu(handle),Full_Scale_Freq_Elec_Hz);
//! \endcode
//! \param[in] handle  The estimator (EST) handle
//! \return    The slip frequency, pu
extern float_t EST_getFslip_pu(EST_Handle handle);
...
//! float_t Id_rated_pu = EST_getIdRated_pu(handle);
...
//!
//! float_t pu_to_amps_sf = _IQ(USER_IQ_FULL_SCALE_CURRENT_A);
//! float_t Id_rated_pu = EST_getIdRated_pu(handle);
//! float_t Id_rated_A = _IQmpy(Id_rated_pu, pu_to_amps_sf);
//! \endcode
//! \param[in] handle  The estimator (EST) handle
...
//! #define USER_IQ_FULL_SCALE_FREQ_Hz (500.0)
//!
//! float_t Mechanical_Frequency_pu = EST_getFm_pu(handle);
//! float_t pu_to_khz_sf = _IQ(USER_IQ_FULL_SCALE_FREQ_Hz/1000.0);
//! float_t Mechanical_Frequency_khz = _IQmpy(Mechanical_Frequency_pu, pu_to_khz_sf);
//! \endcode
//! \param[in] handle  The estimator (EST) handle
...
//!
//! uint_least8_t Rs_qFmt = EST_getRs_qFmt(handle);
//! float_t fullScaleResistance = _IQ(USER_IQ_FULL_SCALE_VOLTAGE_V/USER_IQ_FULL_SCALE_CURRENT_A);
//! float_t Rs_pu = _IQ30toIQ(EST_getRs_pu(handle));
//! float_t pu_to_ohms_sf = VarShift(fullScaleResistance, 30 - Rs_qFmt);
//! float_t Rs_Ohms = _IQmpy(Rs_pu, pu_to_ohms_sf);
//! \endcode
//! \param[in] handle  The estimator (EST) handle
...
//! float_t DcBus_pu = EST_getDcBus_pu(handle);
...
//! #define USER_IQ_FULL_SCALE_VOLTAGE_V (300.0)
//!
//! float_t pu_to_kv_sf = _IQ(USER_IQ_FULL_SCALE_VOLTAGE_V/1000.0);
//! float_t DcBus_pu = EST_getDcBus_pu(handle);
//! float_t DcBus_kV = _IQmpy(DcBus_pu, pu_to_kv_sf);
//! \endcode
//! \param[in] handle  The estimator (EST) handle
...
extern float_t EST_getIdRated_pu(EST_Handle handle);
...
extern float_t EST_getIdRated_indEst_pu(EST_Handle handle);


//! \brief     Gets the Id current value used for flux estimation of induction motors in per unit (pu), IQ24.
//! \param[in] handle  The estimator (EST) handle
//! \return    The Id rated value, pu
extern float_t EST_getIdRated_ratedFlux_pu(EST_Handle handle);
...
//! float_t fullScaleInductance = _IQ(USER_IQ_FULL_SCALE_VOLTAGE_V/(USER_IQ_FULL_SCALE_CURRENT_A * USER_VOLTAGE_FILTER_POLE_rps));
//! float_t Lr_pu = _IQ30toIQ(EST_getLr_pu(handle));
//! float_t pu_to_h_sf = VarShift(fullScaleInductance, 30 - Lr_qFmt);
//! float_t Lr_H = _IQmpy(Lr_pu, pu_to_h_sf);
//! \endcode
//! \param[in] handle  The estimator (EST) handle
//! \return    The rotor inductance value, pu
extern float_t EST_getLr_pu(EST_Handle handle);
...
extern float_t EST_getLs_max_pu(EST_Handle handle);
...
//!
//! float_t pu_to_khzps_sf = _IQ((float_t)USER_TRAJ_FREQ_Hz * USER_IQ_FULL_SCALE_FREQ_Hz / 1000.0);
//! float_t khzps_to_krpmps_sf = _IQ(60.0 / (float_t)USER_MOTOR_NUM_POLE_PAIRS);
//! 
//! float_t Accel_pu = EST_getMaxAccel_pu(handle);
//! float_t Accel_kilo_hz_per_sec = _IQmpy(Accel_pu, pu_to_khzps_sf);
//! float_t Accel_kilo_rpm_per_sec = _IQmpy(Accel_kilo_hz_per_sec, khzps_to_krpmps_sf);
//! \endcode
...
//!
//! float_t hzps_to_pu_sf = _IQ(1.0 / ((float_t)USER_TRAJ_FREQ_Hz * USER_IQ_FULL_SCALE_FREQ_Hz));
//! 
//! float_t Accel_hertz_per_sec = _IQ(USER_MAX_ACCEL_Hzps);
//! float_t Accel_pu = _IQmpy(Accel_hertz_per_sec, hzps_to_pu_sf);
//! \endcode
//! \param[in] handle  The estimator (EST) handle
//! \return    The maximum acceleration value, pu
extern float_t EST_getMaxAccel_pu(EST_Handle handle);
...
//! float_t est_Accel_kilo_hz_per_sec = _IQmpy(est_Accel_pu, pu_to_khzps_sf);
//! float_t est_Accel_kilo_rpm_per_sec = _IQmpy(est_Accel_kilo_hz_per_sec, khzps_to_krpmps_sf);
//! \endcode
//! \details   The default value is set by a user's defined value in user.h, and the default value in per
//!            units is calculated internally as follows:
//! \code
...
//! float_t hzps_to_pu_sf = _IQ(1.0 / ((float_t)USER_TRAJ_FREQ_Hz * USER_IQ_FULL_SCALE_FREQ_Hz));
//! 
//! float_t est_Accel_hertz_per_sec = _IQ(USER_MAX_ACCEL_EST_Hzps);
//! float_t est_Accel_pu = _IQmpy(est_Accel_hertz_per_sec, hzps_to_pu_sf);
//! \endcode
//! \param[in] handle  The estimator (EST) handle
//! \return    The maximum estimation acceleration value, pu
extern float_t EST_getMaxAccel_est_pu(EST_Handle handle);
...
//! #define USER_IQ_FULL_SCALE_CURRENT_A      (10.0)
//!
//! float_t pu_to_kA_per_sec_sf = _IQ((float_t)USER_TRAJ_FREQ_Hz * USER_IQ_FULL_SCALE_CURRENT_A / 1000.0);
//!
//! float_t currentSlope_pu = EST_getMaxCurrentSlope_pu(handle);
//! float_t currentSlope_kAps = _IQmpy(currentSlope_pu, pu_to_kA_per_sec_sf);
//! \endcode
//! \details   The default value is set by a user's defined value in user.h, and the default value in per
//!            units is calculated internally as follows:
//! \code
...
//!
//! float_t A_per_sec_to_pu_sf = _IQ(1.0 / ((float_t)USER_TRAJ_FREQ_Hz * USER_IQ_FULL_SCALE_CURRENT_A));
//!
//! float_t currentSlope_Aps = _IQ(USER_MOTOR_RES_EST_CURRENT);
//! float_t currentSlope_pu = _IQmpy(currentSlope_Aps, A_per_sec_to_pu_sf);
//! \endcode
//! \param[in] handle  The estimator (EST) handle
//! \return    The maximum current slope value, pu
extern float_t EST_getMaxCurrentSlope_pu(EST_Handle handle);
...
//! float_t pu_to_kA_per_sec_sf = _IQ((float_t)USER_TRAJ_FREQ_Hz * USER_IQ_FULL_SCALE_CURRENT_A / 1000.0);
//!
//! float_t currentSlope_epl_pu = EST_getMaxCurrentSlope_epl_pu(handle);
//! float_t currentSlope_epl_kAps = _IQmpy(currentSlope_epl_pu, pu_to_kA_per_sec_sf);
//! \endcode
//! \details   The default value is set by a user's defined value in user.h, and the default value in per
//!            units is calculated internally as follows:
//! \code
...
//! float_t A_per_sec_to_pu_sf = _IQ(1.0 / ((float_t)USER_TRAJ_FREQ_Hz * USER_IQ_FULL_SCALE_CURRENT_A));
//!
//! float_t currentSlope_epl_Aps = _IQ(0.3 * USER_MOTOR_RES_EST_CURRENT);
//! float_t currentSlope_epl_pu = _IQmpy(currentSlope_epl_Aps, A_per_sec_to_pu_sf);
//! \endcode
//! \param[in] handle  The estimator (EST) handle
//! \return    The maximum EPL current slope value, pu
extern float_t EST_getMaxCurrentSlope_epl_pu(EST_Handle handle);
...
extern float_t EST_getRr_pu(EST_Handle handle);
...
extern float_t EST_getRs_pu(EST_Handle handle);
...
extern void EST_getRsOnLineFilterParams(EST_Handle handle,const EST_RsOnLineFilterType_e filterType,
                                        float_t *pFilter_0_b0,float_t *pFilter_0_a1,float_t *pFilter_0_y1,
                                        float_t *pFilter_1_b0,float_t *pFilter_1_a1,float_t *pFilter_1_y1);
...
extern float_t EST_getRsOnLine_pu(EST_Handle handle);
...
extern float_t EST_getTorque_lbin(EST_Handle handle);


//! \brief     Gets the torque value in per unit (pu), IQ24.
//! \param[in] handle  The estimator (EST) handle
//! \return    The torque value, N*m
extern float_t EST_getTorque_Nm(EST_Handle handle);
...
//! \code
//! float_t Overwrite_Flux_Angle_pu = _IQ(0.5);
...
extern void EST_setAngle_pu(EST_Handle handle,const float_t angle_pu);


//! \brief     Sets the DC bus voltage in the estimator in per unit (pu), IQ24.
//! \param[in] handle    The estimator (EST) handle
//! \param[in] dcBus_pu  The DC bus voltage, pu
extern void EST_setDcBus_pu(EST_Handle handle,const float_t dcBus_pu);
...
//! #define USER_FORCE_ANGLE_FREQ_Hz  (1.0)
//!
//! float_t delta_hz_to_pu_sf = _IQ(1.0/(float_t)USER_EST_FREQ_Hz);
//! float_t Force_Angle_Freq_Hz = _IQ(USER_FORCE_ANGLE_FREQ_Hz);
//! float_t Force_Angle_Delta_pu = _IQmpy(Force_Angle_Freq_Hz, delta_hz_to_pu_sf);
//!
...
extern void EST_setFreqB0_lp_pu(EST_Handle handle,const float_t b0_lp_pu);
...
extern void EST_setFreqBeta_lp_pu(EST_Handle handle,const float_t beta_lp_pu);
...
extern void EST_setIdRated_pu(EST_Handle handle,const float_t IdRated_pu);
...
//! float_t Ls_d_pu = _IQ30(USER_MOTOR_Ls_d / L_max);
//!
...
extern void EST_setLs_d_pu(EST_Handle handle,const float_t Ls_d_pu);
...
extern float_t EST_getLs_delta_pu(EST_Handle handle);
...
extern void EST_setLs_delta_pu(EST_Handle handle,const float_t Ls_delta_pu);
...
extern float_t EST_getRs_delta_pu(EST_Handle handle);


//! \brief     Sets the delta stator resistance value
//! \param[in] handle       The estimator (EST) handle
//! \param[in] Rs_delta_pu  The delta stator resistance value, pu
extern void EST_setRs_delta_pu(EST_Handle handle,const float_t Rs_delta_pu);
...
//! uint_least8_t Ls_qFmt = 30 - lShift;
//! float_t L_max = fullScaleInductance * pow(2.0,lShift);
//! float_t Ls_d_pu = _IQ30(USER_MOTOR_Ls_q / L_max);
//!
...
extern void EST_setLs_q_pu(EST_Handle handle,const float_t Ls_q_pu);
...
extern void EST_setMaxAccel_pu(EST_Handle handle,const float_t maxAccel_pu);
...
extern void EST_setMaxAccel_est_pu(EST_Handle handle,const float_t maxAccel_pu);
...
extern void EST_setMaxCurrentSlope_pu(EST_Handle handle,const float_t maxCurrentSlope_pu);
...
//! \param[in] handle              The estimator (EST) handle
//! \param[in] maxCurrentSlope_pu  The maximum current slope value, pu
extern void EST_setMaxCurrentSlope_epl_pu(EST_Handle handle,const float_t maxCurrentSlope_pu);


//! \brief     Sets the rotor resistance value in the estimator in per unit (pu), IQ30.
//! \param[in] handle   The estimator (EST) handle
//! \param[in] Rr_pu    The rotor resistance value, pu
extern void EST_setRr_pu(EST_Handle handle,const float_t Rr_pu);
...
extern void EST_setRsOnLine_pu(EST_Handle handle,const float_t Rs_pu);
...
extern void EST_setRsOnLineId_mag_pu(EST_Handle handle,const float_t Id_mag_pu);
...
extern void EST_setFe_neg_max_pu(EST_Handle handle,const float_t fe_neg_max_pu);
...
extern void EST_setFe_pos_min_pu(EST_Handle handle,const float_t fe_pos_min_pu);
