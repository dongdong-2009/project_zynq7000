...
typedef enum {
  ...
  CTRL_State_OffLineOffsetComp, //! \Add By Dl.K Offset
  CTRL_State_InitDete, 			//! \Add By Dl.K Initial Position Detection
  CTRL_State_StaticStatorInitDete,//! \Add By Dl.K Initial Position Detection
  CTRL_State_OpenLoop, 			//! \Add By Dl.K Open Loop Control
  CTRL_State_OnLine,            //!< the controller online state
  CTRL_State_CurrentCloseLoop,            //!< the controller online state
  CTRL_State_SpeedCloseLoop,            //!< the controller online state
