...
#define PWM_FREQ ((u16) 50000)  //PWM_FREQ ((u16) 14400)          // in Hz  (N.b.: pattern type is center aligned)

/****    Deadtime Value   ****/
#define DEADTIME_NS	((u16) 2000)         //in nsec  
...
#define REP_RATE (9)  // (N.b): Internal current loop is performed every 
...
#define PID_TORQUE_REFERENCE  127   //(N.b.: that's the reference init value in 
                                      // open speed-loop)
