...
#define CKTIM	((u32)192000000uL) 	/* Silicon running at 60MHz Resolution: 1Hz */
...
/****	 Pattern type is center aligned  ****/
	...
	////////////////////////////// Deadtime Value /////////////////////////////////
	#define DEADTIME1  (u16)((unsigned long long)CKTIM/2 \
			  *(unsigned long long)DEADTIME_NS/1000000000uL) 
	#define DEADTIME2  ((DEADTIME1/2)-64)
	#define DEADTIME3  ((DEADTIME1/8)-32)
	#define DEADTIME4  ((DEADTIME1/16)-32)
