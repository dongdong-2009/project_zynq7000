...
#define RX_MIO_PIN_MODE ((0x1UL << 12) | (0x11UL << 9) | (0x01UL << 8) | (0x7UL << 5))
#define TX_MIO_PIN_MODE (                (0x11UL << 9) | (0x01UL << 8) | (0x7UL << 5))
...
static struct hw_uart_device _uart_device0 =
{
    ...
    .rxmio = (rt_uint32_t*)(Zynq7000_SLCR_BASE+0x07c8), /* MIO10 */
    .txmio = (rt_uint32_t*)(Zynq7000_SLCR_BASE+0x07cC), /* MIO11 */
};
