...
#elif defined(TIMER4_HANDLES_ENCODER)		 // TIMER4_HANDLES_ENCODER
#define ENCODER_TIMER         TIM4          // Encoder unit connected to TIM4
#elif defined(TIMER5_HANDLES_ENCODER)
#define ENCODER_TIMER         TIM5			//Encoder unit conneted to TIM5
#endif

/*****************************  Encoder settings ******************************/
#define ENCODER_PPR           (625)   // number of pulses per revolution

/* Define here the absolute value of the application minimum and maximum speed 
                                                                in 0.1Hz unit*/
#define MINIMUM_MECHANICAL_SPEED  (1)    //0.1Hz
#define MAXIMUM_MECHANICAL_SPEED  (6000) //600Hz

/* Define here the number of consecutive error measurement to be detected 
   before going into FAULT state */

#define MAXIMUM_ERROR_NUMBER (25)
