...
#define USER_USING_DOCURRENTCTRL

#define USER_USING_MOTORBOARD_ZYNQ
#ifdef USER_USING_MOTORLOWLEVEL
#define PWM_COMPONENT
#define ADC_COMPONENT
//#define USER_USING_XADC
#define USER_MOTOR_MISC

#define MOTOR_MISC_COMPONENT
#define USER_USING_AD7606
#define QEP_COMPONENT
#endif
